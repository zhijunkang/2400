					...
					<div class="span12">
						...
						<div class="portlet box blue" style="border: 0px;">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>发送物品</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix" style="margin-top: 30px;">
									<div class="btn-group">
										...
										<span style="margin:20px 0px 5px 20px;font-size:18px;font-weight: 600;">物品id:</span>
										<input type="text" class="form-control" id="gid" placeholder="物品id是纯数字" style="height: 30px; font-size: 16px; margin: 0 10px 0 10px;" />
										<span style="margin:20px 0px 5px 20px;font-size:18px;font-weight: 600;">数量:</span>
										<input type="text" class="form-control" id="num" placeholder="物品数量" style="height: 30px; font-size: 16px; margin: 0 10px 0 10px;" />

										<button  class="btn blue" style="margin-left: 10px; width: 80px; font-size: 16px;" onclick="addgoods()">
										确定
										</button>
									</div>
								</div>
