...
public class MountServiceImpl implements IMountService{
	...
	public int updateMountForRid(Mount mount) {
		// TODO Auto-generated method stub
		int mid = mountMapper.selectMountRole(mount);
		Mount mount2=RedisControl.getV(RedisParameterUtil.MOUNT, mid+"", Mount.class);
	...
	public List<MountRoleUser> selectMount(MountRoleUser mru) {
		// TODO Auto-generated method stub
		Integer start = ((mru.getPageNum() - 1) * this.limit) + 1;
