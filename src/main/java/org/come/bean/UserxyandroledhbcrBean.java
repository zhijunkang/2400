...
public class UserxyandroledhbcrBean {
	...
	public String toString() {
		return "UserxyandroledhbcrBean [id=" + this.id + ", username=" + this.username + ", userid=" + this.userid + ", xsum=" + this.xsum + ", xnow=" + this.xnow + ", xdsum=" + this.xdsum + ", dsum=" + this.dsum + ", sssum=" + this.sssum
				+ ", time=" + this.time + "]";
	}
