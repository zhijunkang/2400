...
public class Goodstable implements Cloneable{
	...
	public Integer getUsetime() {
		if (this.usetime == null)setUsetime(1);
		return (int) JmSum.MZ(this.usetime);
	}
	...
	public boolean isQh(Goodstable good) {
		...
		int v1=this.qhv!=null?this.qhv:0;
		int v2=good.qhv!=null?good.qhv:0;
		if (v1!=v2) {return false;}			
		
		v1=this.qht!=null?this.qht:0;
		v2=good.qht!=null?good.qht:0;
		if (v1!=v2) {return false;}			
		
		v1=this.qhb!=null?this.qhb:0;
