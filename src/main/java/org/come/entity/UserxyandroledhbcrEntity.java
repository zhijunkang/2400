...
public class UserxyandroledhbcrEntity {
	...
	public String toString() {
		return "UserxyandroledhbcrEntity [id=" + this.id + ", userid=" + this.userid + ", username=" + this.username + ", roleid=" + this.roleid + ", rolename=" + this.rolename + ", type=" + this.type + ", xsum=" + this.xsum
				+ ", xnow=" + this.xnow + ", xdsum=" + this.xdsum + ", dsum=" + this.dsum + ", sssum=" + this.sssum + ", time=" + this.time + ", sid=" + this.sid + "]";
	}
