...
//    private final List<String> allowedOrigins = Arrays.asList("http://localhost:9090","http://localhost:8083","http://localhost:18083","http://8.141.57.10:8083");// 允许跨域的地址
    private final List<String> allowedOrigins = Arrays.asList("http://localhost:9090","http://localhost:8083","http://localhost:18083");// 允许跨域的地址
    @Override
