...
public class Agreement {
	...
	//机器人
	    ...
	    public String FlyCarryAgreement(String Content){
	        return  NewAESUtil.AESJDKEncode(AgreementUtil.flycarry+FG+Content);
	    }
		// 刷怪任务
	...
	// 创建验证
	public String yanCodeAgreement() {
		return NewAESUtil.AESJDKEncode(AgreementUtil.YAN_CODE + FG);
	}

	// 创建验证
	public String yanCodeAgreement(byte [] Content) {
		return NewAESUtil.AESJDKEncode(AgreementUtil.YAN_CODE + FG + Content);
	}


	// 校验验证码
	public String checkYanCode(String Content) {
		return NewAESUtil.AESJDKEncode(AgreementUtil.CHECK_YAN_CODE + FG + Content);
	}
...
//		}
    ...
    //泡点经验
    public String updateXianyuAgreement(String Content) {
