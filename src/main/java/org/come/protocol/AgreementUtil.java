...
public class AgreementUtil {
	...
	public static final String jiqiren="jiqiren";//机器人
	public  static  final  String usefly="usefly";
	public static final String chat="chat";//聊天频道

	public static final String rolePath = "rolePath";// 千里眼
	
	public static final String deletefriend="deletefriend";//删除好友
	public static final String npc="npc";//npc报文
	public static final String kejunpc="kejunpc";//科举相关
	public static final String kejuhuida="kejuhuida";//科举回答
	...
	public static final String fly="fly";//飞行
//	public static final String buy="buy";//购买物品 同228
	...
	public static final String flyget="flyget";//获取飞行器(通过坐骑卡获取)
...
//    public static final String fightingresponse="fig3";//战斗响应
	...
	public static final String item = "item";// 使用物品卡产生装备 
	...
	public static final String GMSHOP = "GMSHOP";//发送物品
	public static final String QMJC = "QMJC";//全民竞猜
	public static final String laddArena="laddArena";//天梯竞技
	public static final String roleAttribute="roleAttribute";//多属性
	public static final String expAdd="expAdd";//多属性
	public static final String updateXianyu="updateXianyu";//锁定技能扣除仙玉
	public static final String CBGoodDeliver = "CBGoodDeliver"; //卖家发货

	public static final String autoSwitch = "autoSwitch";// 装备属性

	public  static final String YAN_CODE="yanCode";//创建验证码
	public static final String CHECK_YAN_CODE="checkYanCode";// 校验验证码
}
