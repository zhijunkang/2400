        ...
        if (this.addList.size() > DataBaseManage.a) {
            try {
                ...
                for (int i = this.addList.size() - 1; i >= 0; i--) {
                    try {
                        AllServiceUtil.getPalService().insertPalSql(this.addList.get(i));
                    } catch (Exception e2) {
                        try {
        ...
        if (this.delList.size() > DataBaseManage.a) {
            try {
                ...
                for (int i = this.delList.size() - 1; i >= 0; i--) {
                    try {
                        AllServiceUtil.getPalService().deletePalSql(this.delList.get(i));
                    } catch (Exception e2) {
                        try {
        ...
        if (this.updList.size() > DataBaseManage.a) {
            try {
                ...
                for (int i = this.updList.size() - 1; i >= 0; i--) {
                    try {
                        AllServiceUtil.getPalService().updatePalSql(this.updList.get(i));
                    } catch (Exception e2) {
                        try {
