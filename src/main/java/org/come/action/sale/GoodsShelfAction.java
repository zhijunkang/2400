...
public class GoodsShelfAction implements IAction {
	...
	public void action(ChannelHandlerContext ctx, String message) {
		...
		// 手续费
		BigDecimal middlePay = new BigDecimal(salegoods.getSaleprice().longValue() * 2 / 100);
...
//					return;
			...
			SendMessage.sendMessageToSlef(ctx, Agreement.getAgreement().tipAgreement("物品" + salegoods.getSalename() + "已上架成功，扣除手续费" + middlePay.longValue() + "仙玉"));
		} else {
			// 提示金币不足
