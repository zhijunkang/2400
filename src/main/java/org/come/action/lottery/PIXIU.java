...
//		System.out.println(getPixiu().prizePool/size);
	...
	public int getDS(int extra){
		Integer bs=this.itDouble.get(extra);
	...
	public void initAward(){
		this.baseAwards=new long[4];
		this.baseAwards[0]=BASE*4;
		this.baseAwards[1]=BASE*8;
		this.baseAwards[2]=BASE*40;
		this.baseAwards[3]=BASE*100;
	}
