...
//    		return 1;/**判断是否是神兵*/
	...
	static String MSG7 = "#Y神器问世，谁与争锋!何大雷双手将七级#R{物品名}#Y奉上，瞪大了眼睛叹道:“阁下莫非远古神魔吗，冷漠的#G{角色名}#Y，强装镇静的接过#R{物品名}”";
	static String MSG8 = "#Y神器问世，谁与争锋!何大雷双手将八级#R{物品名}#Y奉上，惊道:“真乃天意啊，也只有#G{角色名}#Y， 才配得上这绝世神兵”";
	static String MSG9 = "#Y神器问世，谁与争锋!何大雷双手将九级#R{物品名}#Y奉上，叹道:“我何大雷此生能打出此等神物死而无憾#G{角色名}#Y， 颤抖的接过#R{物品名}”。";
	static String MSG10 = "#Y神器问世，谁与争锋!刚出炉的十级#R{物品名}#Y所产生的能量波直接蹦飞了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道可怜的何大雷不知何时才能痊愈!";
	static String MSG11 = "#Y神器问世，谁与争锋!刚出炉的十一级#R{物品名}#Y所产生的能量波直接蹦死了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道此天地间再无何大雷!";
	static String MSG12 = "#Y上古神器问世，谁与争锋!刚出炉的十二级#R{物品名}#Y所产生的能量波直接蹦死了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道此天地间再无何大雷!";
	static String MSG13 = "#Y上古神器问世，谁与争锋!刚出炉的十三级#R{物品名}#Y所产生的能量波直接蹦死了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道此天地间再无何大雷!";
	static String MSG14 = "#Y上古神器问世，谁与争锋!刚出炉的十四级#R{物品名}#Y所产生的能量波直接蹦死了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道此天地间再无何大雷!";
	static String MSG15 = "#Y上古神器问世，谁与争锋!刚出炉的十五级#R{物品名}#Y所产生的能量波直接蹦死了何大雷，#G{角色名}#Y默默的拿起#R{物品名}#Y惋惜道此天地间再无何大雷!";
...
//		#c00FFFF鸿运当头，[玩家名]成功合成7级宝石[宝石名]，天地为之一震！#89
	...
	public static void PYJN(String rolename,String petname,String skillname){
		...
		buffer.append("#R");
		buffer.append(rolename);
		buffer.append("#c00FFFF的#G");
		buffer.append(petname);
		buffer.append("#c00FFFF修炼终成正果,领悟了#Y[");
		buffer.append(skillname);
		buffer.append("]#c00FFFF技能。#50");
		NChatBean bean=new NChatBean();
		bean.setId(5);
		bean.setMessage(buffer.toString());
		String msg = Agreement.getAgreement().chatAgreement(GsonUtil.getGsonUtil().getgson().toJson(bean));
...
//			bean.setMessage("#Y乌云遮日,电闪雷鸣,#R"+rolename+"#Y在仙玉转盘中竟然抽中了#R5万仙玉#Y,让诸位英雄豪杰羡煞不已#89");
//		}else {
//			bean.setMessage("祥瑞彩照,鸿运当头.玩家【#G"+rolename+"#Y】在上古宝藏中中意外获得【#B"+value+"#Y】#24,真乃好运!");
//		}
		bean.setMessage("#Y天道之外,轮回之中,恭喜#G【"+rolename+"】#Y被几率大神附身,在刮刮乐中获得#R【"+value+"】#Y大奖#97转身挥一挥衣袖不带走一片云彩#50");
		String msg = Agreement.getAgreement().chatAgreement(GsonUtil.getGsonUtil().getgson().toJson(bean));
		SendMessage.sendMessageToAllRoles(msg);
	}
}
