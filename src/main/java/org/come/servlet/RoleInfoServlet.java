...
public class RoleInfoServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//设置搜索条件
		this.roleTable.setUserString(sureType(type));
		...
		//设置当前页码
		this.roleTable.setStart((Integer.valueOf(pagenum) - 1) * 8);
		this.roleTable.setEnd((Integer.valueOf(pagenum)) * 8);
		//3、禁言 4、封号5、未封号  6、未禁言
		if (statues.equals(3 + "")) this.roleTable.setUnknown(1 + "");
		if (statues.equals(4 + "")) this.roleTable.setActivity(new Short(1 + ""));
		if (statues.equals(5 + "")) this.roleTable.setActivity(new Short(0 + ""));
		if (statues.equals(6 + "")) this.roleTable.setActivity(null);
		//设置角色名
		if ((!(rolename.equals(0 + ""))))
			this.roleTable.setRolename(rolename);
		else if (rolename.equals(0 + "")) this.roleTable.setRolename(null);

		//设置账号
		if ((!(plarcess.equals(0 + ""))))
			this.roleTable.setLocalname(plarcess);
		else if (plarcess.equals(0 + "")) this.roleTable.setLocalname(null);
