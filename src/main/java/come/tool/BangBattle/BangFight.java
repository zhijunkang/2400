...
public class BangFight {
	...
	public BigDecimal getPK(){
		if (this.PKstate==0) {
			if (this.Launch!=null)return this.Launch.getCamp();
		}
		return null;
	}
	public BangFight(int sum,BangPoints Camp_Left_ID,BangPoints Camp_Right_ID) {
		...
		this.sum=sum;
		this.PKCountDown=TIME_GAO;
	}
	public Build getBuild(int bh){
		switch (bh) {
		case 0:return this.LongCannon;
		case 1:return this.Left_Gate;
		case 2:return this.Left_FIRE_1;
		case 3:return this.Left_FIRE_2;
		case 4:return this.Left_ICE_1;
		case 5:return this.Left_ICE_2;
		case 11:return this.Right_Gate;
		case 12:return this.Right_FIRE_1;
		case 13:return this.Right_FIRE_2;
		case 14:return this.Right_ICE_1;
		case 15:return this.Right_ICE_2;
		}
	...
	public Map<String,Member> getMap(BigDecimal gang_id){
		...
		if (this.Camp_Left_ID!=null)
			if (gang_id.compareTo(this.Camp_Left_ID.getId())==0)
				return this.Camp_Left_Man;
		if (this.Camp_Right_ID!=null)
	        if (gang_id.compareTo(this.Camp_Right_ID.getId())==0)
	...
	public BigDecimal getBuildCamp(int bh){
		if (bh<=5){
			if (this.Camp_Left_ID==null)return new BigDecimal(-1);
			return this.Camp_Left_ID.getId();
		}else {
			if (this.Camp_Right_ID==null)return new BigDecimal(-1);
	...
	public Member getrole(String RoleName){
		Member role=null;
		if (role==null) {
			if (this.Camp_Left_Man!=null) {
				role=this.Camp_Left_Man.get(RoleName);
			}
		}
		if (role==null) {
			if (this.Camp_Right_Man!=null) {
				role=this.Camp_Right_Man.get(RoleName);
			}
		}
		return role;
	}
...
//   	 //开炮
	...
	public void process(){
        ...
        this.PKCountDown--;
        if (this.PKCountDown<=0) {
        	StringBuffer buffer=new StringBuffer();
        	buffer.append("新的一轮挑战赛开始!");
        	if (this.PKstate==0) {//判断是否有人怂了
            if (this.Launch==null) {
            	buffer.append("本轮挑战赛没有人参与!");	
			}else {
				Build door=getDoor(this.Launch.getKey());
...
//					  addFeat(role,5);
	...
	public boolean isEnd(){
		if (this.BangState!=1||this.time>=TIME_END||this.Left_Gate.getHp()<=0||this.Right_Gate.getHp()<=0) {
			isVictory();
			return true;
		}
		return false;
	...
	public void isVictory(){
		if (this.Left_Gate.getHp()<=0) {
			PVictory(this.Camp_Right_ID,this.Camp_Left_ID);
		}else if (this.Right_Gate.getHp()<=0) {
			PVictory(this.Camp_Left_ID,this.Camp_Right_ID);
