...
public class Ql implements Cloneable{
		...
		//仙法反击
		private double hffj=0;//火法反击
		private double lffj=0;//雷法反击
		private double sffj=0;//水法反击
		private double fffj=0;//风法反击
		
		private double sfmsfs=0;//被攻击时释放魔神附身
		private double sfhqmm=0;//被攻击时释放含情脉脉
		private double sfqkjs=0;//被攻击时释放乾坤借速
		...
		public void addKKUp(double up){
			if (this.khl>up) {this.khl=up;}
			if (this.khs>up) {this.khs=up;}
			if (this.kfy>up) {this.kfy=up;}
			if (this.kyw>up) {this.kyw=up;}
		}
		/**抗上限过滤*/
		public void addKUp(double up){
			if (this.kwl>up) {this.kwl=up;}
			if (this.kzs>up) {this.kzs=up;}
			if (this.kff>up) {this.kff=up;}
			if (this.klf>up) {this.klf=up;}
			if (this.ksf>up) {this.ksf=up;}
			if (this.khf>up) {this.khf=up;}
			if (this.kzd>up) {this.kzd=up;}
			if (this.kgh>up) {this.kgh=up;}
			if (this.klb>up) {this.klb=up;}
			if (this.kzml>up) {this.kzml=up;}
		}
		/**附加攻击判断*/
		public double MFj(){
		...
		/**加强判断*/
		public boolean MJq(){
			if (this.qff>200) {if (this.qff>300) {return true;}this.qff=200;}
			if (this.qlf>200) {if (this.qlf>300) {return true;}this.qlf=200;}
			if (this.qsf>200) {if (this.qsf>300) {return true;}this.qsf=200;}
			if (this.qhf>200) {if (this.qhf>300) {return true;}this.qhf=200;}
			if (this.qgh>200) {if (this.qgh>300) {return true;}this.qgh=200;}
			
			if (this.qhl>200) {if (this.qhl>300) {return true;}this.qhl=200;}
			if (this.qhs>200) {if (this.qhs>300) {return true;}this.qhs=200;}
			if (this.qzs>200) {if (this.qzs>300) {return true;}this.qzs=200;}
			if (this.qfy>200) {if (this.qfy>300) {return true;}this.qfy=200;}
			if (this.qzd>200) {if (this.qzd>300) {return true;}this.qzd=200;}
			if (this.qyw>200) {if (this.qyw>300) {return true;}this.qyw=200;}
			if (this.qzds>300) {if (this.qzds>400) {return true;}this.qzds=300;}
			
			if (this.qqk>100) {if (this.qqk>150) {return true;}this.qzds=100;}

			if (this.qsc>25000) {if (this.qsc>35000) {return true;}this.qsc=25000;}
			
			if (this.qlpl>125) {if (this.qlpl>200) {return true;}this.qlpl=125;}
			if (this.qlfy>125) {if (this.qlfy>200) {return true;}this.qlfy=125;}
			if (this.qlcb>125) {if (this.qlcb>200) {return true;}this.qlcb=125;}
		...
		public boolean MHs(){
			...
			if (this.hfyv>150) {if (this.hfyv>200) {return true;}this.hfyv=150;}

			if (this.hff>200) {if (this.hff>250) {return true;}this.hff=200;}
			if (this.hlf>200) {if (this.hlf>250) {return true;}this.hlf=200;}
			if (this.hsf>200) {if (this.hsf>250) {return true;}this.hsf=200;}
			if (this.hhf>200) {if (this.hhf>250) {return true;}this.hhf=200;}
			if (this.hgh>200) {if (this.hgh>250) {return true;}this.hgh=180;}
			if (this.hxfcd>200) {if (this.hxfcd>250) {return true;}this.hxfcd=180;}
			
			if (this.hzs>15) {if (this.hzs>30) {return true;}this.hzs=15;}
            return false;
		}
		/**额外判断*/
		public boolean MEw(){
			
			if (this.swsx>100) {if (this.swsx>150) {return true;}this.swsx=100;}
			
			if (this.ssc>25000) {if (this.ssc>35000) {return true;}this.ssc=25000;}
			if (this.szd>25000) {if (this.szd>35000) {return true;}this.szd=25000;}
			
			if (this.sff>15000) {if (this.sff>25000) {return true;}this.sff=15000;}
			if (this.slf>15000) {if (this.slf>25000) {return true;}this.slf=15000;}
			if (this.ssf>15000) {if (this.ssf>25000) {return true;}this.ssf=15000;}
			if (this.shf>15000) {if (this.shf>25000) {return true;}this.shf=15000;}
			if (this.sgh>15000) {if (this.sgh>25000) {return true;}this.sgh=15000;}
			
			if (this.blfcd>70) {if (this.blfcd>100) {return true;}this.blfcd=70;}
			if (this.bffcd>70) {if (this.bffcd>100) {return true;}this.bffcd=70;}
			if (this.bsfcd>70) {if (this.bsfcd>100) {return true;}this.bsfcd=70;}
			if (this.bhfcd>70) {if (this.bhfcd>100) {return true;}this.bhfcd=70;}
			if (this.bghcd>70) {if (this.bghcd>100) {return true;}this.bghcd=70;}
			if (this.bsccd>70) {if (this.bsccd>100) {return true;}this.bsccd=70;}

			if (this.exfljs>10) {if (this.exfljs>15) {return true;}this.exfljs=10;}

			if (this.eljv>15) {if (this.eljv>25) {return true;}this.eljv=15;}
			return false;
		}
		/**五行判断*/
		public boolean MWx(){
			if (this.wxj>100) {if (this.wxj>200) {return true;}this.wxj=100;}
			if (this.wxm>100) {if (this.wxm>200) {return true;}this.wxm=100;}
			if (this.wxt>100) {if (this.wxt>200) {return true;}this.wxt=100;}
		...
		public void Reset(){
			...
			kzsmp=0;kjge=0;kqw=0;khr=0;kqm=0;ktm=0;kxl=0;kfg=0;kgs=0;kzml=0;
			...
			hffj=0;lffj=0;sffj=0;fffj=0;//风法反击
			sfmsfs=0;sfhqmm=0;sfqkjs=0;//被攻击时释放乾坤借速
