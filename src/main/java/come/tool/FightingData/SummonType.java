...
public class SummonType {
	...
	public static void xianzhi(ManData data,FightingSkill skill){
		...
		//只能使用一次的技能1608  1606 1611 1612 1828
		 if (id==1606||id==1608||id==1611||id==1612||id==1828||id==7019||id==7013||id==7015||id==7027||id==1313||id==1314||id==1315||id==1250||id==1251||id==1261||id==23009) {
