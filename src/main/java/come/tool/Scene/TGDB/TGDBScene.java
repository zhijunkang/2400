...
public class TGDBScene implements Scene{
	...
	public void init(){
		...
		this.tgdbMonsters[0]=new TGDBMonster();
		this.tgdbMonsters[0].setI(1);
		this.tgdbMonsters[0].setHp(5);
		this.tgdbMonsters[0].setBean(getMonster(GameServer.getAllRobot().get("801"),0));
		
		this.tgdbMonsters[1]=new TGDBMonster();
		this.tgdbMonsters[1].setI(2);
		this.tgdbMonsters[1].setHp(5);
		this.tgdbMonsters[1].setBean(getMonster(GameServer.getAllRobot().get("802"),1));
		
		this.tgdbMonsters[2]=new TGDBMonster();
		this.tgdbMonsters[2].setI(3);
		this.tgdbMonsters[2].setHp(5);
		this.tgdbMonsters[2].setBean(getMonster(GameServer.getAllRobot().get("803"),2));
		
		this.tgdbMonsters[3]=new TGDBMonster();
		this.tgdbMonsters[3].setI(4);
		this.tgdbMonsters[3].setHp(5);
		this.tgdbMonsters[3].setBean(getMonster(GameServer.getAllRobot().get("804"),3));
