...
public class UserService {
	...
	public List<Map<String,String>> getData(){
		...
		map.put("icon", "rid-content grid-con-1");
		map.put("title", "游戏玩家总数");
		...
		map.put("icon", "grid-content grid-con-2");
		...
		map = new LinkedHashMap<String, String>();
		map.put("icon", "grid-content grid-con-3");
		...
		// 当前在线玩家
		map = new LinkedHashMap<String, String>();
		map.put("icon", "grid-content grid-con-1");
