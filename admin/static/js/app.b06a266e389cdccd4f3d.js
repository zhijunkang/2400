webpackJsonp([30], {
	...
	D4f1: function(e, t, n) {
		...
		var o = {
				render: function() {
					...
					return (this._self._c || e)("span", [this._v("后台管理")])
				},
				staticRenderFns: []
			},
	...
	NHnr: function(e, t, n) {
		...
		var p = new c.a({
			...
			f = n("zL8q"),
			d = n.n(f),
			m = (n("KhYh"), n("AXE3"), n("mPoC"), n("tvR6"), n("mtWM")),
			h = n.n(m),
			g = n("XLwt"),
			b = n.n(g),
			v = n("NYxO"),
			...
			I = {
				...
				mutations: {
					addTab: function(e, t) {
						...
						for (var n = 0; n < e.tabnavBox.length; n++)
							if (e.tabnavBox[n].path === t.path) return !1;
						e.tabnavBox.push({
							title: t.title,
							path: t.path
					...
					removeOtherTab: function(e, t) {
						if (e.tabnavBox = [{
								title: "主页",
								path: "/index"
							}], t.all) return t.router.push("/index"), !1;
		...
		n("CuRo");
		u.default.use(f.Button), u.default.use(f.Carousel), u.default.use(f.CarouselItem), u.default.use(f.Form), u.default
			.use(f.FormItem), u.default.use(f.Input), u.default.use(f.Card), u.default.use(f.Dropdown), u.default.use(f.DropdownMenu),
			u.default.use(f.DropdownItem), u.default.use(f.Badge), u.default.use(f.Collapse), u.default.use(f.CollapseItem),
			u.default.use(f.Table), u.default.use(f.TableColumn), u.default.use(f.Loading.directive), u.default.use(f.Pagination),
			u.default.use(f.Container), u.default.use(f.Menu), u.default.use(f.Submenu), u.default.use(f.MenuItem), u.default
			.use(f.MenuItemGroup), u.default.use(f.Aside), u.default.use(f.Main), u.default.use(f.Footer), u.default.use(f.Header),
			u.default.use(f.Tooltip), u.default.use(f.Row), u.default.use(f.Col), u.default.use(f.Tabs), u.default.use(f.TabPane),
			u.default.use(f.Dialog), u.default.use(f.Select), u.default.use(f.Option), u.default.use(f.OptionGroup), u.default
			.use(f.Upload), u.default.use(f.Tag), u.default.prototype.$loading = f.Loading.service, u.default.prototype.$msgbox =
			f.MessageBox, u.default.prototype.$alert = f.MessageBox.alert, u.default.prototype.$confirm = f.MessageBox.confirm,
			u.default.prototype.$prompt = f.MessageBox.prompt, u.default.prototype.$notify = Notification, u.default.prototype
			.$message = f.Message;
		var S = n("D4f1");
		h.a.interceptors.request.use(function(e) {
				...
				return 401 == e.data.code && (localStorage.clear(), p.replace({
					path: "/login"
				})), e
			}, function(e) {
				if (401 !== e.response.status) return a.a.reject(e);
				localStorage.clear(), p.replace({
					path: "/login"
				})
			}), u.default.component("sys-name", S.a), h.a.defaults.baseURL = "/GameServer/", u.default.config.productionTip = !
			1, u.default.use(d.a, {
				size: "medium"
			}), u.default.prototype.$http = h.a, u.default.prototype.$echarts = b.a, p.beforeEach(function(e, t, n) {
				if (0 === e.matched.length) return n("/error"), !1;
				localStorage.getItem("token") || "/login" === e.path || "/register" === e.path ? navigator.userAgent.indexOf(
					"MSIE") > -1 && "/editor" === e.path ? u.default.prototype.$alert(
					"vue-quill-editor组件不兼容IE10及以下浏览器，请使用更高版本的浏览器查看", "浏览器不兼容通知", {
